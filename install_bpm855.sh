...
ls /vagrant/binario_bpm/ | while read line
do
	echo "CMD> [tar xvfz /vagrant/binario_bpm/$line -C /tmp/bpm_server]"
	tar xvfz /vagrant/binario_bpm/$line -C /tmp/bpm_server > /dev/null
done
