...
-- create the database:
create database CELLDB automatic storage yes  using codeset UTF-8 territory US pagesize 32768;
...
UPDATE DB CFG FOR CELLDB USING LOGFILSIZ 16384 DEFERRED;
UPDATE DB CFG FOR CELLDB USING LOGSECOND 64 DEFERRED;
